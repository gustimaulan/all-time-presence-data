  ...
  return (
    <div className="bg-gray-50 border-b border-gray-200 px-4 py-2">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          ...
          {(totalItems !== undefined || filteredItems !== undefined) && (
            <span className="text-sm text-gray-600">
              {searchQuery && filteredItems !== undefined ? (
                <>
                  <span className="font-medium text-blue-600">{filteredItems}</span> search results
                ...
                <>
                  ...
                  {selectedYear && <span className="text-gray-500"> ({selectedYear})</span>}
                </>
              ) : (
        ...
        {/* Cache Status */}
        {cached && (
          <div className="flex items-center text-blue-500" title="Data served from cache">
            <Database size={14} />
